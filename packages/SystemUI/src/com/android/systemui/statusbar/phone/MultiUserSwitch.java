...
public class MultiUserSwitch extends FrameLayout implements View.OnClickListener {
    ...
    public void onClick(View v) {
        if (UserSwitcherController.isUserSwitcherAvailable(mUserManager)) {
            ...
            /// M: Support "CMCC RCS profile on SystemUI Statusbar". @{
            if (FeatureOptionUtils.isOP01RcsSupport()) {
                final Intent intent = new Intent("android.intent.action.view.profile");
