...
public class NetworkControllerImpl extends BroadcastReceiver
    ...
    public static class MobileSignalController extends SignalController<
        ...
        public void setIMSState(int imsState) {
            Xlog.d(TAG, "old IMSState=" + mIMSState + ", new IMSState=" + imsState);
            mIMSState = imsState;
            updateVoLTE();
        }
        /// M: Support "SystemUI - VoLTE icon". @}
...
// End of Vanzo:tanglei
        ...
        private final void updateNetworkType() {
            ...
            if (mServiceState != null) {
                ...
                if ((mDataState == TelephonyManager.DATA_UNKNOWN ||
                    ...
                    Xlog.d(TAG, "updateNetworkType: DataState= " + mDataState
            ...
            Xlog.d(TAG, "updateNetworkType: DataNetType=" + mDataNetType + " / " + tempNetworkType);
            ...
            Xlog.d(TAG, "updateNetworkType: mNetworkType= " + mNetworkType);
        }
        /// M: Support "Service Network Type on Statusbar". @}
        ...
        private int getDataNetworkTypeFromService() {
            ...
            ///M: Support SVLTE. @{
            if (SvLteController.isMediatekSVLteDcSupport(mSubscriptionInfo)) {
                dataNetType = mSvLteController.getDataNetTypeWithLTEService(dataNetType);
            }
            ///M: Support SVLTE. @}
        ...
        private final void updateTelephony() {
            ...
            if (mCurrentState.networkType != mLastState.networkType) {
                Xlog.d(TAG, "[NetworkType change] " + "mCurrentState.networkType:"
            ...
            if (mCurrentState.connected) {
                Log.i(TAG, "[CMCC Performance test][SystemUI][Statusbar] show signal end ["
    ...
    public interface SignalCluster {
         ...
         * @param isShowed : Show VoLTE icon or not
        ...
        public boolean isOffline(int subId) {
            ...
            if (controller != null) {
                if (SvLteController.isMediatekSVLteDcSupport(controller.mSubscriptionInfo)) {
                    isOffline = controller.mSvLteController.isOffline();
                } else {
