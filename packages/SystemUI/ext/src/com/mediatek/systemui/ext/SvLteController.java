...
public class SvLteController {
    ...
    public boolean isOffline() {
        final boolean isEmergencyOnly = isEmergencyOnly();
        ...
        final boolean isOffline = isEmergencyOnly || !isRadioOn || extraSubRadioOn;
    ...
    public static final boolean isMediatekSVLteDcSupport(final SubscriptionInfo info) {
        return info != null && isMediatekSVLteDcSupport() && isSvlteSlot(info.getSubscriptionId());
    }
