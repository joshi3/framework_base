...
public class PhoneStateExt {
    ...
    protected void toString(final StringBuilder builder) {
        builder.append(getClass().getSimpleName() + " : ")
                .append("mSubId=").append(mSubId).append(',')
                .append("mSlotId=").append(mSlotId).append(',')
                .append("mMobileVisible=").append(mMobileVisible).append(',')
                .append("mMobileStrengthIcon=").append(mMobileStrengthIcon).append(',')
                .append("mMobileDataTypeIcon=").append(mMobileDataTypeIcon).append(',')
                .append("mIsMobileTypeIconWide=").append(mIsMobileTypeIconWide).append(',')
                .append("mMobileDescription=").append(mMobileDescription).append(',')
                .append("mMobileTypeDescription=").append(mMobileTypeDescription);
    }
}
