...
public class KeyguardFingerprintUnlockView extends LinearLayout implements KeyguardSecurityView {

    private static final String TAG = "FULKeyguardFingerprintUnlockView";
    private static final boolean DEBUG = false;
    private KeyguardSecurityCallback mKeyguardSecurityCallback;
    private LockPatternUtils mLockPatternUtils;
    private FingerprintUnlock mBiometricUnlock;
    private View mFingerprintUnlockAreaView;
    ...
    public KeyguardFingerprintUnlockView(Context context) {
        this(context, null);
    }

    public KeyguardFingerprintUnlockView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    public void setKeyguardCallback(KeyguardSecurityCallback callback) {
        ...
        ((FingerprintUnlock)mBiometricUnlock).setKeyguardCallback(callback);
    }
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        mBiometricUnlock.initializeView(mFingerprintUnlockAreaView);
    }

    private void initializeBiometricUnlockView() {
        if (DEBUG) Log.d(TAG, "initializeBiometricUnlockView()");
        mFingerprintUnlockAreaView = findViewById(R.id.fingerprint_unlock_area_view);
        if (mFingerprintUnlockAreaView != null) {
            mBiometricUnlock = new FingerprintUnlock(mContext);
    ...
    KeyguardUpdateMonitorCallback mUpdateCallback = new KeyguardUpdateMonitorCallback() {
        ...
        public void onUserSwitchComplete(int userId) {
            ...
            if (mBiometricUnlock.userAuthenticated(userId)) {
            	Log.d(TAG, "userAuthenticated, dismiss keyguard");
            	mKeyguardSecurityCallback.dismiss(true);
            } else {
            	Log.d(TAG, "userAuthenticated = false");
            }
