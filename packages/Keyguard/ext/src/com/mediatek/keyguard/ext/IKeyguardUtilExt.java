...
public interface IKeyguardUtilExt {
     ...
     *
     * @return true if need show toast
     */
    void showToastWhenUnlockPinPuk(Context context, int simLockType) ;
     ...
     */
    boolean needCustomizePinPukLockView();
     ...
     */
    Drawable getCustomizedSimIcon(int phoneId, Drawable icon);
}
