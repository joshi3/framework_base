...
public class AppWidgetProvider extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (AppWidgetManager.ACTION_APPWIDGET_UPDATE.equals(action)) {
            ...
            Log.d("AppWidgetProvider", "ACTION_APPWIDGET_UPDATE extras "+extras);
            if (extras != null) {
            ...
            Bundle extras = intent.getExtras();
            Log.d("AppWidgetProvider", "ACTION_APPWIDGET_OPTIONS_CHANGED extras "+extras);
            if (extras != null && extras.containsKey(AppWidgetManager.EXTRA_APPWIDGET_ID)
                    && extras.containsKey(AppWidgetManager.EXTRA_APPWIDGET_OPTIONS)) {
            	Log.d("AppWidgetProvider", "ACTION_APPWIDGET_OPTIONS_CHANGED extras != null ");
        	...
        	Log.d("AppWidgetProvider", "ACTION_APPWIDGET_ENABLED  ");
