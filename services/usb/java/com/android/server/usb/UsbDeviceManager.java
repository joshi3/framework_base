...
/* Vanzo:tanglei on: Thu, 26 Feb 2015 17:04:55 +0800
 */
...
public class UsbDeviceManager {
   ...
   private static final int MTP_RESET_TIME = 60000;
    ...
    private static final boolean bEvdoDtViaSupport = SystemProperties.get("ro.evdo_dt_support").equals("1");
...
/* Vanzo:tanglei on: Thu, 26 Feb 2015 17:05:11 +0800
 * fix bug #106031
 */
...
/* Vanzo:tanglei on: Thu, 26 Feb 2015 16:42:10 +0800
 * fix bug #106031
 */
                    if (FeatureOption.MTK_SHARED_SDCARD && !isHaveExternalSDCard()
                            && containsFunction(mCurrentFunctions, UsbManager.USB_FUNCTION_MASS_STORAGE)) {
                        setCurrentFunctions(UsbManager.USB_FUNCTION_MTP, true);
                        removeFunction(mCurrentFunctions, UsbManager.USB_FUNCTION_MASS_STORAGE);
                        addFunction(mCurrentFunctions, UsbManager.USB_FUNCTION_MTP);
                        setUsbConfig("none");
                        setUsbConfig(mCurrentFunctions);
                    }
// End of Vanzo:tanglei
