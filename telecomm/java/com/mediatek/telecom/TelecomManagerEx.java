...
public class TelecomManagerEx {
    ...
    /**
     * Here defines a special key to distinguish the call is marked as "waiting" state at remote
     * side. Its value should be Boolean. see IConnectionServiceAdapter.updateExtras()
     * @hide
     */
